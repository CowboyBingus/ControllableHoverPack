...
with zipfile.ZipFile(sys.argv[1]) as z:
    ...
    m=json.loads(z.read('manifest.json'));assert m['Name']=='Controllable Hover Pack - v1' and m['Options'][0]['Include']==['data']
    ...
    p=json.loads(z.read('ControllableHoverPack-manifest.json'));assert p['runtime_verified'] and p['requires'][0]['revision']=='loader-v11'
